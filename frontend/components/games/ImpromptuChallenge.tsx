...
const TOPICS: Topic[] = [
  ...
  // WSC 2026 "Are We There Yet?" Theme Topics
  {
    id: 'topic-16',
    category: 'WSC',
    topic: 'Are we there yet with equality?',
    hints: ['Consider different types of equality (gender, racial, economic)', 'Measure progress with data', 'Acknowledge what remains unfinished'],
    difficulty: 'hard',
  },
  {
    id: 'topic-17',
    category: 'WSC',
    topic: 'The journey to Mars: worth the cost?',
    hints: ['Compare the budget to other global priorities', 'Consider technological spinoffs', 'Think about humanity\'s long-term survival'],
    difficulty: 'hard',
  },
  {
    id: 'topic-18',
    category: 'Hypothetical',
    topic: 'If destinations didn\'t exist, would we still travel?',
    hints: ['Think about why people travel vs. why they arrive', 'Consider nomadic cultures', 'What drives exploration?'],
    difficulty: 'hard',
  },
  {
    id: 'topic-19',
    category: 'WSC',
    topic: 'Progress is just an illusion.',
    hints: ['Define what progress means', 'Give examples of progress that created new problems', 'Consider whether "better" is always clear'],
    difficulty: 'hard',
  },
  {
    id: 'topic-20',
    category: 'WSC',
    topic: 'The best journeys have no map.',
    hints: ['Think about discovery vs. planning', 'Personal examples of unplanned success', 'When is structure harmful?'],
    difficulty: 'medium',
  },
  {
    id: 'topic-21',
    category: 'Opinion',
    topic: 'We\'ve arrived at the future, and it\'s disappointing.',
    hints: ['Compare sci-fi predictions with reality', 'What did we gain vs. what we expected?', 'Is disappointment a sign of ambition?'],
    difficulty: 'medium',
  },
  {
    id: 'topic-22',
    category: 'Explain',
    topic: 'Explain why getting lost can be better than arriving.',
    hints: ['Learning through mistakes', 'Unexpected discoveries', 'Growth happens outside comfort zones'],
    difficulty: 'medium',
  },
  {
    id: 'topic-23',
    category: 'Persuade',
    topic: 'Convince someone to take the scenic route instead of the highway.',
    hints: ['What do you see that you\'d miss?', 'Time vs. experience', 'Memories formed along the way'],
    difficulty: 'easy',
  },
  {
    id: 'topic-24',
    category: 'WSC',
    topic: 'If you could measure human progress with one number, what would it be?',
    hints: ['GDP? Life expectancy? Literacy? Happiness?', 'Why is one number insufficient?', 'What does your choice reveal about your values?'],
    difficulty: 'hard',
  },
  {
    id: 'topic-25',
    category: 'WSC',
    topic: 'The most important journey is the one you take alone.',
    hints: ['Self-discovery and independence', 'Counter: collaboration and shared experience', 'When does solitude become isolation?'],
    difficulty: 'medium',
  },
  {
    id: 'topic-26',
    category: 'Opinion',
    topic: 'Why do we always ask "are we there yet" instead of enjoying the ride?',
    hints: ['Human impatience vs. mindfulness', 'Goal-oriented culture', 'What children understand that adults forget'],
    difficulty: 'easy',
  },
  {
    id: 'topic-27',
    category: 'Hypothetical',
    topic: 'Describe a destination that moves further away the closer you get.',
    hints: ['Think metaphorically: perfection, happiness, world peace', 'Use a vivid image or story', 'Connect to real-world goals'],
    difficulty: 'hard',
  },
  {
    id: 'topic-28',
    category: 'WSC',
    topic: 'Should we stop trying to "arrive" and learn to just "be"?',
    hints: ['Eastern vs. Western philosophy', 'Ambition vs. contentment', 'Can a society function without goals?'],
    difficulty: 'hard',
  },
  {
    id: 'topic-29',
    category: 'Explain',
    topic: 'How the internet changed the meaning of "being somewhere."',
    hints: ['Virtual presence vs. physical presence', 'Remote work and online communities', 'Has distance lost its meaning?'],
    difficulty: 'medium',
  },
  {
    id: 'topic-30',
    category: 'Persuade',
    topic: 'Is the last mile always the hardest?',
    hints: ['Examples from science, sports, and politics', 'Why do projects stall near completion?', 'The psychology of finishing'],
    difficulty: 'medium',
  },
];
