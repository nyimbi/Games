...
GAME_DEFINITIONS: list[GameDefinition] = [
	...
	GameDefinition(
		type="math_hangman",
		name="Math Hangman",
		description="Guess a mystery number's digits using mathematical property clues before the hangman is drawn.",
		category="scholars_challenge",
		sync_type="solo",
		icon="calculator",
		duration_minutes=5,
	...
	GameDefinition(
		type="sequence_sleuth",
		name="Sequence Sleuth",
		description="Complete number patterns and identify the rule: arithmetic, geometric, Fibonacci, and more.",
		category="scholars_challenge",
		sync_type="solo",
		icon="trending-up",
		duration_minutes=6,
	...
	GameDefinition(
		type="fraction_faceoff",
		name="Fraction Face-Off",
		description="Sort a mixed set of fractions, decimals, and percentages from smallest to largest under pressure.",
		category="scholars_challenge",
		sync_type="solo",
		icon="percent",
		duration_minutes=5,
	...
	GameDefinition(
		type="prime_patrol",
		name="Prime Patrol",
		description="Click every prime number in a grid before the timer runs out. Wrong clicks penalise.",
		category="scholars_challenge",
		sync_type="solo",
		icon="shield",
		duration_minutes=5,
	...
	GameDefinition(
		...
		description="Fill in the missing operators (+, −, ×, ÷) to make the equation true.",
		category="scholars_challenge",
		sync_type="solo",
		icon="equal",
		duration_minutes=6,
	...
	GameDefinition(
		type="shape_sherlock",
		name="Shape Sherlock",
		description="Deduce a 2D shape from numerical clues — area, perimeter, angles, symmetry lines.",
		category="scholars_challenge",
		sync_type="solo",
		icon="triangle",
		duration_minutes=5,
	...
	GameDefinition(
		type="estimation_nation",
		name="Estimation Nation",
		description="Estimate order-of-magnitude answers. No need to be exact — scored by closeness.",
		category="scholars_challenge",
		sync_type="solo",
		icon="target",
		duration_minutes=5,
	...
	GameDefinition(
		type="graph_guesser",
		name="Graph Guesser",
		description="Match real-world scenarios to the correct graph type: linear, quadratic, exponential, and more.",
		category="scholars_challenge",
		sync_type="solo",
		icon="bar-chart",
		duration_minutes=5,
	...
	GameDefinition(
		type="number_connections",
		name="Number Connections",
		description="Group 16 numbers into 4 sets that share a hidden mathematical property.",
		category="scholars_challenge",
		sync_type="solo",
		icon="grid",
		duration_minutes=8,
	...
	GameDefinition(
		type="divisibility_dash",
		name="Divisibility Dash",
		description="Identify every divisibility rule that applies to each number as fast as possible.",
		category="scholars_challenge",
		sync_type="solo",
		icon="divide",
		duration_minutes=5,
